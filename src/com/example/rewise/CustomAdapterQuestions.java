...
public class CustomAdapterQuestions extends BaseAdapter   implements OnClickListener {
         ...
         public CustomAdapterQuestions(Activity a, ArrayList<?> d,Resources resLocal) {
                 activity = a;
                 data= d;
                 res = resLocal;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
         ...
         private class OnItemClickListener  implements OnClickListener{          
             ...
             public void onClick(View arg0) {
               InstrShowQuestion sct = (InstrShowQuestion)activity;
