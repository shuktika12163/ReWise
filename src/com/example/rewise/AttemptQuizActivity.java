...
public class AttemptQuizActivity extends FragmentActivity implements OnItemClickListener, OnClickListener {
	...
	static AttemptQuestionFragment curFrag;
	...
	public void initQ()
	{
		...
		q.explanation="We are Stuuupiiiiidddd";
		alQ.add(q);
		
		q=new Question(false);
		q.setTitle("What does the fox say?");
		...
		q.explanation="In which century are u living?";
		alQ.add(q);

		q=new Question(true);
		q.setTitle("What is the API level of Android Watch?");
		q.addOption("19");
		q.addOption("20");
		q.addOption("21");
		q.addOption("22");
		q.addCorrectAnswer(1);
		q.explanation="20 - 4.4W";
		alQ.add(q);

		q=new Question(true);
		q.setTitle("Which Pokemon do we all like");
...
//					onClick(findViewById(R.id.btnSubmit));
	...
	public void markAnswers()
	{
		...
		{
			f.tvE.setText("Explanation: "+f.q.explanation);
			f.adapter.isViewing=true;
