...
public class InstrCourseQuizAdapter extends BaseExpandableListAdapter{
    ...
    public InstrCourseQuizAdapter(ArrayList<Course> p,Context context)
    {
    	parents=p;
            ...
            View convertView, ViewGroup parentView)
    {
    	...
    	Log.e("I",String.valueOf(parent.getChildren().size()));
