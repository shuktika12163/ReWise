...
public class InstrQuizStatsOverviewAdapter extends BaseAdapter{
          
         private Activity activity;
         private ArrayList<?> data;
         private static LayoutInflater inflater=null;
         InstrQuizStats tempValues=null;
         int i=0;
          
         public InstrQuizStatsOverviewAdapter(Activity a, ArrayList<?> d) {
                 activity = a;
                 data= d;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
             ...
             {
                 tempValues=null;
                 tempValues = ( InstrQuizStats ) data.get( position );
