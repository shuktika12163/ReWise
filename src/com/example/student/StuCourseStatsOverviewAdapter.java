...
public class StuCourseStatsOverviewAdapter extends BaseAdapter{
          
         private Activity activity;
         private ArrayList<?> data;
         private static LayoutInflater inflater=null;
         StuCourseStats tempValues=null;
         int i=0;
          
         public StuCourseStatsOverviewAdapter(Activity a, ArrayList<?> d) {
                 activity = a;
                 data= d;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
             ...
             {
                 tempValues=null;
                 tempValues = ( StuCourseStats ) data.get( position );
