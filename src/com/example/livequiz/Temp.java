...
public class Temp extends Activity {
	...
	public void onClick(View v)
	{
		...
		if(q.uploadToDB())
			Toast.makeText(Temp.this, "done "+q.get_id(), 0).show();
		else
			Toast.makeText(Temp.this, "not done "+q.get_id(), 0).show();
	}
	
	Question q2;
	public void onClick2(View v){
		q2=new Question(false);
		q2.setQuestion("What does the fox say?");
		...
		q2.setExplanation("In which century are u living?");
		q2.uploadToDB();
	}
	...
	public void onClick4(View v)
	{
		...
		for(Question qq:q.getQuestions())
			Toast.makeText(this, qq.getQuestion(), 0).show();
